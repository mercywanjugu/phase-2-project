...
function About() {
  return (
    <div className="card">
      ...
      This is where all colors that you would wish to know about are found.
      This application can be accesed by everyone so long as they own a smart phone, a computer and wifi.
      </p>
      </div>
    </div>
  )
